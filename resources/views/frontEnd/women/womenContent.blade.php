        ...
        <div class="col-md-8 products-right">
            ...
            <div class="men-wear-top">
                ...
                <div  id="top" class="callbacks_container">
                    <ul class="rslides" id="slider3">
                        <li>
                            <img class="img-responsive" src="{{ asset('public/images') }}/men21.jpg" alt=" "/>
                        </li>
                        <li>
                            <img class="img-responsive" src="{{ asset('public/images') }}/men11.jpg" alt=" "/>
                        </li>
                        <li>
                            <img class="img-responsive" src="{{ asset('public/images') }}/men21.jpg" alt=" "/>
                        </li>
            ...
            <div class="men-wear-bottom">
                <div class="col-sm-4 men-wear-left">
                    <img class="img-responsive" src="{{ asset('public/images') }}/men31.jpg" alt=" " />
                </div>
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    <div class="men-thumb-item">
                        <img src="{{ asset('public/images') }}/a1.png" alt="" class="pro-image-front">
                        <img src="{{ asset('public/images') }}/a1.png" alt="" class="pro-image-back">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="{{ url('/details') }}">T shirt</a></h4>
            ...
            <div class="col-md-4 product-men no-pad-men">
                <div class="men-pro-item simpleCart_shelfItem">
                    ...
                    <div class="item-info-product ">
                        <h4><a href="{{ url('/details') }}">Hand Bag</a></h4>
                        <div class="info-product-price">
                            <span class="item_price">$45.99</span>
                            <del>$69.71</del>
                        </div>
